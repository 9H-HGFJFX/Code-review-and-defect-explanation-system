 ...
 * 用于Spring Security认证
 */
public class JwtUserDetailsAdapter implements UserDetails {

    private final JwtUserDetails jwtUserDetails;

    public JwtUserDetailsAdapter(JwtUserDetails jwtUserDetails) {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return Collections.singletonList(
                new SimpleGrantedAuthority("ROLE_" + jwtUserDetails.getRole().name())
        );
    }
